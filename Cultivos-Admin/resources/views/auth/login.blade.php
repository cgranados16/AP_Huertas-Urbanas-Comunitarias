            ...
            <div class="bg-gd-dusk">
                <div class="hero-static content content-full bg-white invisible" data-toggle="appear">
                    ...
                    <div class="py-30 px-5 text-center">
                        ...
                        <h1 class="h2 font-w700 mt-50 mb-10">{{Lang::get('auth.welcome')}}</h1>
                        <h2 class="h4 font-w400 text-muted mb-0">{{Lang::get('auth.welcome_subtitle')}}</h2>
                    </div>
                    <!-- END Header -->
                                ...
                                <div class="form-group row has-feedback{{ $errors->has('email') ? ' has-error' : '' }}">
                                    <div class="col-12">
                                        <div class="form-material floating">
                                            ...
                                            <label for="login-username">{{Lang::get('auth.email')}}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row has-feedback{{ $errors->has('password') ? ' has-error' : '' }}">
                                    <div class="col-12">
                                        <div class="form-material floating">
                                            ...
                                            <label for="login-password">{{Lang::get('auth.password')}}</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <label class="custom-control custom-checkbox">
                                            ...
                                            <span class="custom-control-description">{{Lang::get('auth.remember me')}}</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group row gutters-tiny">
                                    <div class="col-12 mb-10">
                                        <button type="submit" class="btn btn-block btn-hero btn-noborder btn-rounded btn-alt-primary">
                                            <i class="si si-login mr-10"></i> {{Lang::get('auth.sign in')}}
                                        </button>
                                    </div>
                                </div>
                            </form>
