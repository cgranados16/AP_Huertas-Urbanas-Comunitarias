...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      //  factory(App\Models\CollaboratorsPerGarden::class, 500)->create(); //crea colaboradore
        ...
        //factory(App\Models\Harvest::class, 100)->create();
        //factory(App\Models\Sale::class, 100)->create();
        //factory(App\Models\Trade::class, 100)->create();
        //factory(App\Models\HarvestBySale::class, 400)->create();
        //factory(App\Models\HarvestByTrade::class, 400)->create();
